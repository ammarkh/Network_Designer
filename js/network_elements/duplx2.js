class DIPLX2 {
  constructor(id, x, y, name) {
    ...
    this.cports = [
      ...
      new DoublePort("port-1-down_" + this.id, 1, "down", x + 8, y + 43),
      new DoublePort("port-2-down_" + this.id, 2, "down", x + 25, y + 43),
    ];
  }
  ...
  update(x, y) {
    ...
    this.cports[1].update(x + 8, y + 43);
    this.cports[2].update(x + 25, y + 43);
  }
  /**
