...
class MRFU {
  constructor(id, x, y, name, type) {
    ...
    this.id = id;
    this.name = name;
    this.type = type = "RRU MRFU";
    this.eX = x;
    this.eY = y;
    this.isEmpty = true;
    this.cport = [
      //  new DoublePort(this.id + "prt1_l" + 0, 0, "l", x - 10, y + 12.5),
      new DoublePort("port-1-Left_" + this.id, 0, "left", x - 10, y + 25),
      //  new DoublePort(this.id + "prt1_l" + 2, 2, "l", x - 10, y + 37.5),
      //  new DoublePort(this.id + "prt1_l" + 3, 3, "l", x - 10, y + 50),
      new DoublePort("port-2-Left_" + this.id, 1, "left", x - 10, y + 62.5),
      //  new DoublePort(this.id + "prt1_l" + 5, 5, "l", x - 10, y + 75),

      // new DoublePort(this.id + "prt1_r" + 0, 6, "r", x + 45, y + 12.5),
      // new DoublePort(this.id + "prt1_r" + 1, 7, "r", x + 45, y + 25),
      new DoublePort("port-Right_" + this.id, 3, "right", x + 45, y + 37.5),
      // new DoublePort(this.id + "prt1_r" + 3, 9, "r", x + 45, y + 50),
      // new DoublePort(this.id + "prt1_r" + 4, 10, "r", x + 45, y + 62.5),
      // new DoublePort(this.id + "prt1_r" + 5, 11, "r", x + 45, y + 75),
    ];
  }
