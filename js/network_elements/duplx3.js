class DIPLX3 {
  constructor(id, x, y, type) {
    ...
    this.id = id;
    this.type = type = "Splitter 1 IN - 3 OUT";
    this.eX = x;
    this.eY = y;
    this.isEmpty = true;
    this.cports = [
      new DoublePort("port-top_" + this.id, 0, "top", x + 15, y - 15),
      new DoublePort("port-1-down_" + this.id, 1, "down", x + 5, y + 43),
      new DoublePort("port-2-down_" + this.id, 2, "down", x + 15, y + 43),
      new DoublePort("port-3-down_" + this.id, 3, "down", x + 25, y + 43),
    ];
  }
